...
let profilCtrl = require('./routes/profilCtrl');
let contactCtrl = require('./routes/contactCtrl');
let userCtrl = require('./routes/userCtrl');
let aproposCtrl = require('./routes/aproposCtrl');
let commentaireCtrl = require('./routes/commentaireCtrl');
let sujetCtrl = require('./routes/sujetCtrl');
let etapesCtrl = require('./routes/etapesCtrl')
let ficheCtrl = require('./routes/ficheCtrl');
let kooriCtrl = require('./routes/kooriCtrl');
let iboxCtrl = require('./routes/iboxCtrl');
let serviceCtrl = require('./routes/serviceCtrl');
let rapportCtrl = require('./routes/rapportCtrl')
let phaseCtrl = require('./routes/phaseCtlr')
let validator = require('./validationsCheck/validationFilesRequire')
let sessionCtrl = require('./routes/sessionCtrl')
let evaluation_noteCtrl = require('./routes/evaluation_noteCtrl')
let evaluation_kooriCtrl = require('./routes/evaluation_kooriCtrl')
let evaluation_iboxCtrl = require('./routes/evaluation_iboxCtrl')
let evaluation_ficheCtrl = require('./routes/evaluation_ficheCtrl')
let temoignageCtrl = require('./routes/temoignageCtrl')
let demandeCtrl = require('./routes/demandeCtlr')
...
exports.router= (()=>{
    ...
    // User routes
    apiRouter.route('/get/user/').get(userCtrl.getUsers);
    apiRouter.route('/get/client/').get(userCtrl.getClients);
