...
module.exports = {
    getAllService: (req,res)=>{
        ...
        headerAuth === "*" ? attribute = ['id','libelle', 'description','nom_des_clients','type_de_service', 'description_elements_service', 'benefices_client',
            ...
            'avatar','liste_des_applications_metiers_supporte', 'tarifs_et_Facturation' ,'archive'] : attribute = [headerAuth]
        ...
        asyncLib.waterfall([
            ...
            (errorResult, callback2)=>{
                if (!errorResult){
                    ...
                    const {libelle, nom_des_clients, type_de_service, description, description_elements_service,
                         benefices_client, indicateur_mesure_qualite, engagement_niveaux_service, plage_horaire, livrables, suivi_gestion_relation_client,
                         liste_des_applications_metiers_supporte, tarifs_et_Facturation} = req.body
                    models.Service.create({
                        libelle, nom_des_clients, type_de_service, description, 
                        description_elements_service, benefices_client, 
                        indicateur_mesure_qualite, engagement_niveaux_service, 
                        plage_horaire, livrables,suivi_gestion_relation_client,
